 ...
 * @see app/Http/Controllers/TaskController.php:15
 * @route '/tasks'
 */
 ...
 */
export const show = (
    args: { task: string | number } | [task: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @see app/Http/Controllers/TaskController.php:85
 ...
 * @see app/Http/Controllers/TaskController.php:109
 * @route '/tasks/{task}'
 */
