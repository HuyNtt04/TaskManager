...
export default function TasksIndex({ tasks, lists, filters, flash }: Props) {
    ...
    // --- FIX 1: Hàm xử lý mở form tạo mới để reset sạch sẽ ---
    const handleCreate = () => {
        setEditingTask(null); // Đảm bảo không phải là edit
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Dialog open={isOpen} onOpenChange={setIsOpen}>
                        <Button
                            ...
                            className="bg-primary text-black shadow-lg hover:bg-primary/90"
                        >
